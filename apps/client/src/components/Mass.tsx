  ...
  return (
    <>
      <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        ...
        <p className="mb-10 text-lg font-normal font-zilla text-yellow-100 lg:text-xl sm:px-16 lg:px-48">
        ...
        <div className="mt-10 px-8 max-w-4xl mx-auto flex flex-col space-y-4 sm:flex-row sm:justify-between sm:space-y-0 sm:space-x-4">
          <div className="mb-2 text-white text-center text-lg sm:text-left">
            <p>Title: {cal?.title}</p>
            <p>Colour: {cal?.colour}</p>
          </div>
          <div className="mb-2 text-center sm:text-right text-white text-lg">
